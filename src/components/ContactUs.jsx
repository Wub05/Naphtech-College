  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://naphtech-backend-1.onrender.com/api/contact",
        {
          method: "POST",
          headers: {
            ...
            <div className="lg:col-span-3">
              <div className="relative bg-white rounded-3xl p-8 lg:p-10 shadow-xl shadow-[#1E3A8A]/5 border border-[#1E3A8A]">
                <div className="relative">
                  ...
                  {/* FORM (ONLY FUNCTIONAL CHANGES HERE) */}
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div className="relative group">
                        <input
                          ...
                          className="group peer w-full px-4 pt-6 pb-2 bg-[#F8FAFC] border-2 border-gray-100 rounded-xl text-[#1F2937] placeholder-transparent focus:border-[#3B82F6] focus:bg-white focus:shadow-lg focus:shadow-[#3B82F6]/10 outline-none transition-all duration-300"
                          placeholder="Full Name"
                        />
                        <label
                          htmlFor="name"
                          className="absolute left-4 top-3 group-focus-within:top-1 text-sm text-[#9CA3AF]"
                        >
                          Full Name
                        </label>
                      </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      ...
                      <div className="relative group">
                        ...
                        >
                          ...
                          <option value="COC Training">COC Training</option>
                          <option value="English Language Programs">
                            English Language Programs
                          </option>
                          <option value="Nursing">Nursing</option>
                          <option value="Pharmacy">Pharmacy</option>
                    ...
                    <div className="relative group">
                      <textarea
                        ...
                        onChange={handleChange}
                        className="group peer w-full px-4 pt-6 pb-2 bg-[#F8FAFC] border-2 border-gray-100 rounded-xl text-[#1F2937] placeholder-transparent focus:border-[#3B82F6] focus:bg-white focus:shadow-lg focus:shadow-[#3B82F6]/10 outline-none transition-all duration-300 resize-none"
                        placeholder="Your Message"
                      ></textarea>
                      <label
                        htmlFor="message"
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="group relative w-full bg-gradient-to-r from-[#1E3A8A] to-[#3B82F6] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 overflow-hidden disabled:opacity-70"
                    >
                      <span className="relative z-10 flex items-center gap-3">
                        {loading ? (
                          <>
                    ...
                    {/* STATUS (MODERN TOAST STYLE) */}
                    {status && (
                      <div
                        className={`flex items-center justify-center gap-2 text-sm font-medium px-4 py-3 rounded-xl transition-all duration-300 animate-fade-in ${
                          status === "success"
