export default function COCTraining() {
  return (
    <>
      <section
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center  translate-y-12 transition-all duration-700 ease-out">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1F2937] mb-6 leading-tight font-heading">
                Get Certified with
                <span className="text-[#1E3A8A]"> COC Training</span>
              </h2>

              <p className="text-lg text-[#6B7280] mb-8 leading-relaxed">
                Prepare for National Certification with our comprehensive COC
                Assessment Preparation programs. Gain industry-relevant skills
                that employers recognize and trust.
              </p>

              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#3B82F6] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <svg
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#1F2937] mb-1">
                      COC Assessment Preparation
                    </h3>
                    <p className="text-[#6B7280]">
                      Comprehensive exam preparation to earn your Certificate of
                      Competence
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#1F2937] mb-1">
                      ICT &amp; Hardware Networking
                    </h3>
                    <p className="text-[#6B7280]">
                      Master computer systems, networks, and hardware
                      technologies
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#0EA5E9] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <svg
                      className="w-6 h-6 text-white"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <div>
                    ...
                    <p className="text-[#6B7280]">
                      Learn to repair and maintain mobile devices professionally
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="https://assets.ls-assets.com/provider/istock/2153480515.jpg?w=1200"
